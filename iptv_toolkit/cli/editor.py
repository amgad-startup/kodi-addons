import argparse
import logging
from iptv_toolkit.core.utils import setup_logging
from iptv_toolkit.editor.editor import IPTVEditor
from iptv_toolkit.core.config import DEFAULT_BATCH_SIZE
